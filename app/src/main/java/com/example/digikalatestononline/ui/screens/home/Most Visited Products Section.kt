...
@Composable
fun MostVisitedProductsSection(viewModel: HomeViewModel = hiltViewModel()){
    var mostVisitedProducts by remember { mutableStateOf<List<StoreProducts>>(emptyList()) }
    ...
    when (mostVisitedProductsResult) {
        ...
        is NetworkResult.Error -> {
            Log.e("6191", "mostVisitedProductsResult Api Error is :${mostVisitedProductsResult.message}")
            loading = false
        }
